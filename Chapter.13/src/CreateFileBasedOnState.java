...
public class CreateFileBasedOnState {
	...
	public static void createEmptyFile(Path file, String s)
	{
		...
		//I decided to create an object of ReadStateFile to read the files
		ReadStateFile readStateFile = new ReadStateFile();
		Scanner kb = new Scanner(System.in);
		System.out.print("Enter name of file to use >> ");
		readStateFile.setFileName(kb.nextLine());
		readStateFile.getFile();*/
